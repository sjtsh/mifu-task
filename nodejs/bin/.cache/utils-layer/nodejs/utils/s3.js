...
const FileUtils = require('/opt/nodejs/utils/file');
...
exports.copyObject = async function (source_bucket, target_bucket, file_key) {
    ...
    return await exports.s3Client.copyObject(params).promise()
        .then(data => {
...
exports.deleteObject = async function (bucket, file_key) {
    ...
    return await exports.s3Client.deleteObject(params).promise()
        .then(data => {
